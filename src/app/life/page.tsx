...
const LIFE_POSTS = [
  {
    slug: '2025-life-trip',
    title: '2025 — 一次短途旅行的记录',
    description: '沿着海岸线，记录一些看到的风景与零星感想 — 摄影、咖啡与清晨的散步。',
    date: '2025-11-01',
    category: '旅行'
  },
  {
    ...
    title: '读书笔记：短篇散文合集',
    description: '把一些书里的短句摘录并记下当时的心情与个人理解。',
    date: '2025-08-12',
    category: '读书'
  },
  {
    slug: 'minimal-kitchen-ideas',
    title: '小厨房 · 极简改造',
    description: '乱中有序：分享在有限空间中优化收纳与烹饪效率的心得。',
    date: '2025-05-21',
    category: '居家'
  },
  {
    slug: 'coffee-time',
    title: '咖啡时光 · 日常仪式感',
    description: '清晨一杯咖啡，傍晚一本书，简单的幸福不过如此。',
    date: '2025-04-10',
    category: '日常'
  },
  {
    slug: 'photo-collection-2025',
    title: '2025 摄影集：光影故事',
    description: '用镜头记录生活中的瞬间，光与影的交织。',
    date: '2025-03-28',
    category: '摄影'
  },
  {
...
export default function LifePage() {
  ...
  const paginatedPosts = LIFE_POSTS.slice(
                ...
                <Link href={`/blog/${post.slug}`}>
                  <article className="card card-hover p-6 group">
                    <div className="flex flex-col md:flex-row md:items-center gap-4">
                      {/* Category Badge */}
                      <span className="tag-primary self-start">
                        {post.category}
                      </span>
